...
export function SolutionRequestEmail(props: SolutionRequestEmailProps) {
  const { name, business, businessDescription, email, phone, industry, project, brief } = props;
  return (
    <Html>
      <Head />
          ...
          >
            ...
            {businessDescription && businessDescription.trim() ? (
              <>
                ...
                <Text style={{ ...labelStyle, fontSize: "13px", margin: "0 0 4px" }}>
                  Business description
                </Text>
                <Text style={{ ...row, whiteSpace: "pre-wrap" }}>{businessDescription}</Text>
              </>
            ) : null}
            <Hr style={{ borderColor: "#e6e9ef", margin: "12px 0" }} />
            <Text style={{ ...labelStyle, fontSize: "13px", margin: "0 0 4px" }}>
...
export const template = {
  ...
  previewData: {
    ...
    businessDescription:
      "A private academy offering after-school tutoring for primary and secondary students.",
